  ...
  "inline-flex items-center justify-center  rounded-md text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        priceBadge:
          "bg-purpleLight text-purpleDark h-[29px] md:h-[42px] px-2.5 py-[2.5px] md:px-2.5 md:py-1.5 rounded-[10px] md:rounded-[12px]",
        flavor:
          "bg-white text-black border border-gray-300 h-[36px] rounded-full px-2.5 py-1.5",
        star: "bg-purpleLight text-purpleDark h-[36px] md:h-[42px] px-2.5 py-1.5 md:px-[15px] md:py-2 rounded-[12px]",
        taste:
