...
export default function WineSlider() {
  return (
    <div className='px-[16px] mt-[15px] mb-[24px] w-full max-w-[1140px] mx-auto md:px-[20px] md:mt-[20px] md:mb-[40px] xl:px-0 xl:mt-[10px] xl:mb-[40px]'>
      <section className='w-full h-[241px] rounded-[12px] bg-gray-100 md:h-[299px] md:rounded-[16px] xl:h-[299px] xl:rounded-[16px]'>
        ...
        <div className='relative mt-[20px] md:mt-[30px] xl:mt-[30px]'>
          <Carousel className='w-full'>
            <CarouselContent>
              {mockWines.map((wine) => (
                <CarouselItem key={wine.id} className='basis-auto'>
                  <WineCard {...wine} />
                </CarouselItem>
              ))}
            </CarouselContent>
